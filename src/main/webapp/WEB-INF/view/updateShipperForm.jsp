		...
		<div id="loginbox" style="margin-top: 50px;margin-left:520px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading"  style = " background-color: rgb(45, 45, 48);">
					<div class="panel-title"><h4 style = "text-align:center;">Update Shipper</h4></div>
				</div>

				<div style="padding-top: 30px" class="panel-body">

					<!-- Registration Form -->
					<form:form action="${pageContext.request.contextPath}/admin/updateShipper" 
					...
					<form:hidden path="email" />
						...
						<input  placeholder="email" value="${shipper.email}" readonly class="form-control" />
						</div>
						...
						<!-- Register Button -->
						<div style="margin-top: 10px;margin-left:86px;" class="form-group">						
