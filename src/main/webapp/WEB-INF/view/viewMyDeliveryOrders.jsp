        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <tr class="blank_row">
							    <td colspan="2"><h2 style = "color:white;">Deliveries</h2></td>
							</tr>
                    		  	
							  <tr>
							    <th>Order ID</th>
							    <th>Click here to get customer Details</th>
							  ...
							  <c:url var="viewcust" value="/shipper/viewOrderCustomer">
							  			
							  	<c:param name="customerId" value="${temp.customer.userName}" />
							  	...
							  	<tr>
							  	<td>${temp.id}</td>
							    <td><a href="${viewcust}" class="primary-btn cart-btn">View Customer Details</a></td></td>
