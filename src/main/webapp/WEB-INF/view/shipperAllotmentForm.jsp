		...
		<div id="loginbox" style="margin-top: 50px;margin-left:520px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading" style = " background-color: rgb(45, 45, 48);">
					<div class="panel-title"><h4 style="text-align:center;">Assign Shipper</h4></div>
				</div>
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					<!-- Registration Form -->
					<form action="${pageContext.request.contextPath}/admin/processShipperAllotment" 
						...
						<div style="margin-bottom: 25px" class="input-group">
							...
							<select required name="shipper" class="form-control">
                  					
                  					<!-- loop over all categories -->
                  					
                        		<c:forEach var="temp" items="${shippers}">
                  					<option value="${temp.userName}" label="${temp.userName}"/>
                         		</c:forEach>
