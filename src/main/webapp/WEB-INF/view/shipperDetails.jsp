            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table id="distributors">
                    	 <tr class="blank_row">
							    <td colspan="3"><h2  style = "color:white;text-align:center;">My Shipper Details</h2></td>
							</tr>
							  <tr>
							    <th>Shipper Id</th>
							    <th>Name</th>
							    <th>Email</th>
							  	...
							  	<tr>
							    <td><h5 style = "text-align:center;">${shipper.userName}</h5></td>
							    <td><h5 style = "text-align:center;">${shipper.firstName}</h5></td>
							    <td><h5 style = "text-align:center;">${shipper.email}</h5></td>
