...
<head>
    ...
    <title>View Unprocessed Orders</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table id="distributors">
                      <tr class="blank_row">
							    <td colspan="9"><h2 style = "color:white;">Unprocessed Orders</h2></td>
							</tr>
							  <tr>
							    <th>Order Id</th>
							    <th>Customer Id</th>
							  ...
							  <c:url var="allotShipperLink" value="/admin/allotShipper">
							    ...
							    <td>
									...
									<a href="${allotShipperLink}" class="primary-btn cart-btn">Allot Shipper</a>
							    </td>
							  </tr>
					    </c:forEach>
					</table>
