            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table id="distributors">
                     <tr class="blank_row">
							    <td colspan="7"><h2 style = "color:white;">Your Orders</h2></td>
							</tr>
							  <tr>
							    <th>Order Id</th>
							    <th>Order Status</th>
							  ...
							  <c:url var="shipperDetails" value="/customer/shipperDetails">
							  			
							  		<c:param name="shipperId" value="${temp.shipper.userName}" />
							    ...
							    <td><a href="${shipperDetails}" class="primary-btn cart-btn">Shipper Details</a></td>
