                ...
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table id="distributors">
                             ...
                             <tr class="blank_row">
							    <td colspan="8"><h2 style = "color:white;">Products in the Order</h2></td>
							</tr>
                                <tr>
                                    ...
                                    <th class="shoping_book"> Post a Product Review</th>
                                </tr>
                           
                            <tbody>
                            	<c:forEach var="temp" items="${products}" >
							  	<c:url var="postreview" value="/customer/giveProductReview">
							  			
							  		
							  		<c:param name="productId" value="${temp.primaryKey.product.id}"/>
                                ...
                                <tr>
                                    ...
                                    <td class="shoping__cart__item"style = "text-align:center;">
                                     ...
                                     <td class="shoping_cart_item"><a href="${postreview}" class="primary-btn cart-btn">Post Review</a></td>
                                </tr>
                                </c:forEach>
