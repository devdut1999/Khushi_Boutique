                ...
                <div class="col-lg-6" style = "margin-left : 285px;" >
                    <div class="shoping__checkout" >
                        ...
                        <ul>
                            ...
                            <li>Total Amount <span>Rs. ${total}</span></li>
                        </ul>
                      
					   <a style = "margin-left:165px;"  href="${pageContext.request.contextPath}/customer/toPayment" class="btn btn-primary">Proceed to Checkout</a>
