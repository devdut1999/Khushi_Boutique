		...
		<div id="loginbox" style="margin-top: 50px;margin-left:520px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading" style = " background-color: rgb(45, 45, 48);">
					<div class="panel-title"><h4 style = "text-align:center;">Add/Update Distributor Details</h4></div>
				</div>

				<div style="padding-top: 30px" class="panel-body">

					<!-- Registration Form -->
					<form:form action="${pageContext.request.contextPath}/admin/saveDistributor" 
						  	   modelAttribute="distributor"
						  	   method="POST"
						  	   class="form-horizontal">
					
						<!-- need to associate this data with distributor id -->
						<form:hidden path="id" />
						...
						<div style="margin-bottom: 25px" class="input-group">
							...
							<form:errors path="distributorName" cssClass="error" />
							<form:input path="distributorName" placeholder="Name of Distributor" class="form-control" />
						</div>
