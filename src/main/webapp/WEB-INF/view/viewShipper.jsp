            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <table id="distributors">
                     <tr class="blank_row">
							    <td colspan="10"><h2 style = "color:white;">Shippers</h2></td>
							</tr>
							  <tr>
							    <th>Shipper Id</th>
							    <th>Shipper Name</th>
							  ...
							  <c:url var="updateLink" value="/admin/showFormForUpdateShipper">
							  			
							  		<c:param name="shipperId" value="${temp.userName}" />
